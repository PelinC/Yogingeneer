...
<head>
  ...
  <meta name="google-site-verification" content="BF-MgLZqJXpgjuVUamcMmnqGIIIE-Ccd_2M8XMNzi84" />
...
<body>
  ...
  <!-- Page Header -->
  <header class="masthead" style="background-image: url('{{asset('front/')}}/img/banner.png')">
