...
<body>
  ...
  <nav class="navbar navbar-expand-lg navbar-light fixed-top" id="mainNav">
    <div class="container">
      <a class="navbar-brand ml-auto" href="{{route('resume')}}">CV</a>
...
<div class="container">
  <div class="row">
      ...
      <div class="col-lg-8 col-md-10 mx-auto">
            <h2 style="text-align:center">{{$projects->title}}</h2>
            <center>
            <img class="img-fluid" src="{{asset($projects->image)}}" width="400" height="300" alt="centered image"/>
          </center>
            <div>
            {!!$projects->content!!}
          </div>
            <br>
            <li class="list-inline-item" title="project source-code" >

                  <a target="blank" href="{{$projects->git}}">
          ...
          <hr>
            ...
            <span class="text-red">Readers: <b>{{$projects->hit}}</b></span>
      </div>
